...
* list is used as a collection of hetrogenous data (different types of data- int, string, boolean etc)
* list items are ordered, mutable( changable) and allow duplicate values
...
# acessing a part of list syntax= list[start:end:step]
...
# insert items in agiven index ==> list_arr.insert(index, data)
...
# store apple stock  price for 5 days
...
'''
order of complexity of arary traversal  is O(n).
since we need to iterate over a array
as size increase ,time also increase
...
create a list to store this montly expense  and using that find out

1. In feb,how many dollars you spend extra compare to january?
2. Find out your total expense in first quater of the year(3 months)?
...
and got a refund of 200$. Make a correction to your monthy expense list? 
'''
...
2. Add 'balck panther' at the end of this list
